...
export default function LatestArticles() {
  // Formateur de prix pour la France (€)
    ...
    <section className="py-8">
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm">Découvrez nos dernières pépites sélectionnées pour vous.</p>
        </div>
        <button className="text-indigo-600 font-medium text-sm hover:underline">Voir tout</button>
      </div>
